...
interface DirectorInterface {
  ...
  console.log(createEmployee(200) instanceof Teacher ? "Teacher" : "Director"); // Outputs: Teacher
  console.log(createEmployee(1000) instanceof Teacher ? "Teacher" : "Director"); // Outputs: Director
  console.log(createEmployee('$500') instanceof Teacher ? "Teacher" : "Director"); // Outputs: Director
